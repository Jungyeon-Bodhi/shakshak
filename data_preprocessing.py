...
identifiers = ['Enumerator Name','106', 'today', '_id', '_uuid']
...
cols_new = ['start','end', 'today', 'deviceid', 'Enumerator Name', 'Consent', 'Consent2', 'con_pic1', 'con_pic2',
...
open_cols = ['7-1','9-o','12-1','14-o','26-1','28','29-1','30','32','36','38','106']
