...
def descriptive_statistics(df, indicators):
    ...
    s_intervention = bd.Indicator(df, "intervention", 0, ['5'], i_cal=None, i_type='count', description='Intervention List', period='endline', target = None)
    ...
    province = bd.Indicator(df, "Province", 0, ['4.Burundi'], i_cal=None, i_type='count', description='Province', period='endline', target = None)
    ...
    #intervention_group.add_var_order(['No Disability', 'Disability'])
...
def statistical_indicators(df, indicators):
    ...
    cctd = bd.Indicator(df, "CCTD_impacts", 0, ['CCTD_score'], i_cal=None, i_type='count', description='CCTD Impacts - Overall', s_test = 'stats', s_group = {'2':'Gender', 'Age Group':'Age group',  "Disability":"Disability", "i_group":"Intervention Combination", 'i_type':'Intervention Type'})
    indicators.append(cctd)
    
    wemweb = bd.Indicator(df, "WEMWBS_impacts", 0, ['WEMWBS'], i_cal=None, i_type='count', description='WEMWBS Impacts - Overall', s_test = 'stats', s_group = {'2':'Gender', 'Age Group':'Age group',  "Disability":"Disability", "i_group":"Intervention Combination", 'i_type':'Intervention Type'})
    indicators.append(wemweb)
    
    qols = bd.Indicator(df, "QOLS_impacts", 0, ['QOLS'], i_cal=None, i_type='count', description='QOLS Impacts - Overall', s_test = 'stats', s_group = {'2':'Gender', 'Age Group':'Age group',  "Disability":"Disability", "i_group":"Intervention Combination", 'i_type':'Intervention Type'})
    indicators.append(qols)
    
    df_gbv = df[~df['gbv'].isna()]
    gk = bd.Indicator(df_gbv, "GBV_knowledge_impacts", 0, ['GBV_knowledge'], i_cal=None, i_type='count', description='GBV_knowledge Impacts - Overall', s_test = 'stats', s_group = {'2':'Gender', 'Age Group':'Age group',  "Disability":"Disability", "i_group":"Intervention Combination", 'i_type':'Intervention Type'})
    indicators.append(gk)
    
    cctd_impacts = bd.Indicator(df, "CCTD_impacts_OLS", 0, ['CCTD_score'], i_cal=None, i_type='count', description='CCTD Impacts - OLS Test', s_test = 'ols', s_group = {'2':'Gender', 'Age Group':'Age group',  "Disability":"Disability", "i_group":"Intervention Combination", 'i_type':'Intervention Type'})
    indicators.append(cctd_impacts)
    
    cctd_impacts2 = bd.Indicator(df, "CCTD_impacts_ANOVA", 0, ['CCTD_score'], i_cal=None, i_type='count', description='CCTD Impacts - ANOVA Test', s_test = 'anova', s_group = {'2':'Gender', 'Age Group':'Age group', "Disability":"Disability", "i_group":"Intervention Combination", 'i_type':'Intervention Type'})
    ...
    df_integration = df2[df2['Age Group'] != '17 - 24']
    cctd_impacts_i = bd.Indicator(df_integration, "CCTD_impacts_integration", 0, ['CCTD_score'], i_cal=None, i_type='count', description='CCTD Impacts - ANOVA Test [Integration]', s_test = 'anova', s_group = {'2':'Gender', 'Age Group':'Age group', "Disability":"Disability"})
    indicators.append(cctd_impacts_i)
    
    df_integration2 = df2[df2['i_group'].str.contains('J', na=False)]
    j2h_impacts1_i = bd.Indicator(df_integration2, "J2H_impacts1_integration", 0, ['WEMWBS'], i_cal=None, i_type='count', description='WEMWBS - ANOVA Test [Integration]', s_test = 'anova', s_group = {'2':'Gender', 'Age Group':'Age group', "Disability":"Disability"})
    indicators.append(j2h_impacts1_i)
    
    j2h_impacts2_i = bd.Indicator(df_integration2, "J2H_impacts2_integration", 0, ['QOLS'], i_cal=None, i_type='count', description='QOLS - ANOVA Test [Integration]', s_test = 'anova', s_group = {'2':'Gender', 'Age Group':'Age group', "Disability":"Disability"})
    indicators.append(j2h_impacts2_i) 
    
    j2h_impacts3_i = bd.Indicator(df_integration2, "J2H_impacts3_integration", 0, ['GBV_knowledge'], i_cal=None, i_type='count', description='GBV_knowledge - ANOVA Test [Integration]', s_test = 'anova', s_group = {'2':'Gender', 'Age Group':'Age group', "Disability":"Disability"})
    ...
    knowledge_level2 = bd.Indicator(df_gbv, "GBV_knowledge2", 0, ['GBV_knowledge'], i_cal=None, i_type='count', description='GBV_knowledge2', s_test = 'anova', s_group = {'2':'Gender', 'Age Group':'Age group', "Disability":"Disability"})
...
file_path1 = 'data/Burundi_Descriptive Statistics.xlsx' # File path to save the statistics (including breakdown data)
file_path2 = 'data/Burundi_Test Results.xlsx'  # File path to save the statistical tests
